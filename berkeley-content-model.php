...
add_filter( 'template_include', 'berkeley_genesis_templates' );
function berkeley_genesis_templates( $original_template ) {
	if ( is_search() )
...
add_action( 'wp_enqueue_scripts', 'berkeley_genesis_global_scripts' );
function berkeley_genesis_global_scripts() {
...
add_filter( 'script_loader_tag', 'berkeley_async_genesis_global_scripts', 10, 2 );
function berkeley_async_genesis_global_scripts( $tag, $handle ) {

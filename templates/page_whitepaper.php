...
add_action( 'genesis_header', 'berkeley_eng_whitepaper_header' );

function berkeley_eng_whitepaper_header() {
...
remove_action( 'genesis_footer', 'berkeley_eng_custom_footer' );
remove_action( 'genesis_footer', 'genesis_footer_markup_close', 15 );

add_action( 'genesis_footer', 'berkeley_eng_whitepaper_footer' );

// footer without navigation menus or widget areas
function berkeley_eng_whitepaper_footer() {
...
add_action( 'genesis_entry_footer', 'berkeley_eng_whitepaper_do_sidebar' );

function berkeley_eng_whitepaper_do_sidebar() {
